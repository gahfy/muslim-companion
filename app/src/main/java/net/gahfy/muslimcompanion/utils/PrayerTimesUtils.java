...
public class PrayerTimesUtils {
    ...
    static
    {
        ...
        COUNTRY_DEFAULT_CONVENTION.put("ae", new Pair(Convention.EMIRATES, School.NOT_HANAFI));
        // Afghanistan
        ...
        // United Kingdom
        COUNTRY_DEFAULT_CONVENTION.put("gb", new Pair(Convention.BIRMINGHAM, School.HANAFI));
        // Grenada
        ...
        // Jordan
        COUNTRY_DEFAULT_CONVENTION.put("jo", new Pair(Convention.JORDAN, School.NOT_HANAFI));
        // Japan
        ...
        // Kuwait
        COUNTRY_DEFAULT_CONVENTION.put("kw", new Pair(Convention.KUWAIT, School.NOT_HANAFI));
        // Cayman Islands
        ...
        // Lybia
        COUNTRY_DEFAULT_CONVENTION.put("ly", new Pair(Convention.LYBIA, School.NOT_HANAFI));
        // Morocco
        ...
        // Maldives
        COUNTRY_DEFAULT_CONVENTION.put("mv", new Pair(Convention.MALDIVES, School.NOT_HANAFI));
        // Malawi
        ...
        // Oman
        COUNTRY_DEFAULT_CONVENTION.put("om", new Pair(Convention.OMAN, School.NOT_HANAFI));
        // Panama
        ...
        // Qatar
        COUNTRY_DEFAULT_CONVENTION.put("qa", new Pair(Convention.QATAR, School.NOT_HANAFI));
        // Réunion
        ...
        // Turkey
        COUNTRY_DEFAULT_CONVENTION.put("tr", new Pair(Convention.TURKEY, School.NOT_HANAFI));
        // Trinidad and Tobago
